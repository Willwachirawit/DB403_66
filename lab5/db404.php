...
?>
    ...
    <li>
        ...
        <div>
            ...
            FROM products WHERE UnitPrice*UnitsOnOrder >= 500;
            </code>
            <br>
            <table>
                <tr>
    ...
    <li>
       ...
       <div>
            <code>
            SELECT ContactName, CompanyName FROM customers WHERE CompanyName like "%markets";            </code>
            <br>
            <table>
                <tr>
                    <th>ContactName</th>
    ...
    <li>
        ...
        <div>
            <code>
            SELECT ContactName, CompanyName FROM customers WHERE CompanyName like "%et%";</code>
            <br>
            <table>
                <tr>
                    <th>ContactName</th>
    ...
    <li>
        ...
        <div>
            <code>
            SELECT ContactName, CompanyName FROM customers WHERE CompanyName like '%e_t%';</code>
            <br>
            <table>
                <tr>
                    <th>ContactName</th>
    ...
    <li>
        ...
        <div>
            <code>
            SELECT ContactName, CompanyName FROM customers WHERE CompanyName like '%b_s%';</code>
            <br>
            <table>
                <tr>
                    <th>ContactName</th>
            ...
            <?php
                $sql = "SELECT ContactName, CompanyName FROM customers WHERE CompanyName like '%b_s%';";
                $result = $conn->query($sql);
                while ($row = $result->fetch_assoc()) {
                    echo "<tr>
                            <td>{$row['ContactName']}</td>
    ...
    <li>
        ...
        <div>
            ...
            <?php
                ...
                FROM products 
                WHERE UnitPrice BETWEEN 20 AND 50 ORDER BY `products`.`UnitPrice` ASC";
                $result = $conn->query($sql);
                while ($row = $result->fetch_assoc()) {
                    echo "<tr>
                            <td>{$row['ProductName']}</td>
    ...
    <li>
        ...
        <div>
            ...
            <?php
                ...
                FROM customers 
                WHERE ContactTitle = 'Owner' AND Country IN ('Mexico','Spain','France');";
                $result = $conn->query($sql);
                while ($row = $result->fetch_assoc()) {
                    echo "<tr>
                            <td>{$row['ContactName']}</td>
    ...
    <li>
        ...
        <div>
            ...
            <?php
                $sql = "SELECT ContactName, ContactTitle, Country, CompanyName 
                FROM customers 
                WHERE ContactTitle = 'Owner' AND Country IN ('Mexico','Spain','France') ORDER BY CompanyName LIMIT 2;
                ";
                $result = $conn->query($sql);
                while ($row = $result->fetch_assoc()) {
                    echo "<tr>
    ...
    <li>
        ...
        <div>
            ...
            FROM products 
            WHERE (QuantityPerUnit LIKE '%box%') ORDER BY UnitPrice DESC LIMIT 5;</code>
            <br>
            <table>
                <tr>
                    <th>ProductName</th>
            ...
            <?php
                $sql = "SELECT ProductName,UnitPrice, UnitsInStock, QuantityPerUnit 
                FROM products 
    ...
    <li>
        ...
        <div>
            <code>
            SELECT Country, COUNT(*) AS member FROM customers WHERE Country IN ('UK','France','Spain') GROUP BY Country;</code>
            <br>
            <table>
                <tr>
                    <th>Country</th>
    ...
    <li>
        ราคาเฉลี่ยของสินค้าที่ค้างอยู่ใน Stock จำแนกตามหมวดหมู่ (CategoryID) 
        <div>
            <code>
